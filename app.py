...
app.config['MYSQL_USER'] = 'LoM1eXyPFJ'
app.config['MYSQL_PASSWORD'] = 'I76jjYADE4'
app.config['MYSQL_DB'] = 'LoM1eXyPFJ'
mysql = MySQL(app)
app.secret_key = 'a'
...
def cart_checkout():
    if request.method == 'POST':
        ...
        for i in range(count):
            ...
            if resq <= 0:
                prod = cart[i][3]
                sgemail = Mail(from_email = "sharmarishi519@gmail.com",
                ...
                try:
                    sg = SendGridAPIClient('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')
